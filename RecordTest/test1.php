...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($idRoom !== null && $idQuestion !== null && $idStudent !== null && $nameStudent !== null && $currentQuestion !== null && $questions !== null) {
        ...
        $recordTest = new RecordTest($idRoom, $idQuestion, $idStudent, $nameStudent, 0, 0, 0, $currentQuestion, "N/A", "N/A", $questions);
        ...
        if ($stmt) {
            ...
            $stmt->bind_param('ssssss', $idRoom, $idQuestion, $idStudent, $nameStudent, $currentQuestion, $questions, $currentDay);
